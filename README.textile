...
You can also have a _controller_ startup class and an _environment_ startup class. The start classes follow a defined precedence order: app, controller, and environment. That way, your controller can override any app-wide settings, and your environment can override any app-wide or controller-wide settings.
