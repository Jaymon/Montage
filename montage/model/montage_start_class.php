 ...
 *  
 *  these classes are basically like a configuration file so things should be stored 
 *  in a montage_settings instance (ie, use the start() method of this class to set 
 *  all your settings in montage_settings, retrieved via {@link montage::getSettings()}     
 *  
 *  @abstract 
 *  @version 0.1
