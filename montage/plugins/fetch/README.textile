...
// pass in as many vars as you want, don't worry, they'll be encoded for you...
$fetch->setFields(array('foo' => 'bar'));
...
$response = $fetch->get(); // $response is a fetch_response object instance
echo $response->getPath(); // echo the path the file was saved to
</pre>
